...
- During prediction, provide the nucleotide and amino acid sequences of the virus CDS (coding sequence).  
  ...
  - An example virus (*Severe acute respiratory syndrome coronavirus 2*, SARS‑CoV‑2) is provided under `test/`.
...
- `--pred_dir` stores all prepared inputs and intermediate results (e.g., `virus_host.csv`, `HMM/`, `embedding/`).
