...
def main():
    ...
    embed_file = f"{save_dir}/protein_embed_dict_20250912_010034.pkl"
    func_map_file = f"{save_dir}/protein_func_map_20250912_010034.pkl"
    kegg_host_csv = f"{data_dir}/kegg_host_final.csv"
    host_info_file = f"{data_dir}/host_info_geo_env_0.9.csv"
    
    # 宿主分类信息文件
    host_taxonomy_csv = f"{data_dir}//1016_allcluster_model_dataset_ratio.csv"
